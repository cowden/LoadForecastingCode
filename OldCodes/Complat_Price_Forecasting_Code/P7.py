...
OldWeatherPrice=OldWeatherPriceRead(OldPriceLoc, "RealMarketPriceDataPT.csv",
                                    OldWeatherLoc, "historical_weather.csv")
...
TotalTrainX2, TotalTestX2 = TrainingExtention(TotalTrainX, TotalTestX)




Answer=np.array([20.98,21.19,20.64,21.13,21.78,29.73,34.45,35.69,39.75,
                 37.05,36.5 ,35.18,34.15,33.45,33.32,33.39,33.32,33.45,35.53,40.1,48.04,39.66,36])



Param['MachineList']=['Ridge','Reg']
Param['GBM_NTry']=100
Param['RF_NTree']=110
Param['NGroup']=[1]
...
# $$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
FunRMSE, SavePredict=CrossVal(AvailableDate,TotalTrainX2,TotalTrainY)
...
# $$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
Weight, BestGroup, BestMachine = QuickEnsemble(Param)
SaveForecast=FinalTraining(TotalTrainX2,TotalTrainY,TotalTestX2,Weight,BestGroup,BestMachine)
