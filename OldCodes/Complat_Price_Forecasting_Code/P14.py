...
def ParameterGen(Selection):
    if Selection=='Load':
        ...
        Param={'CVN': 5}
        Param['MachineList']=["RF","GBM","SVMLIB"] # ,","Ridge"
        Param['NGroup']=[1]
        Param['Ensem']="Simple"
        Param['GBM_NTry']=600
        Param['GBM_LRate']=0.1
...
def SingleWeather(WeatherFileLoc):
    ...
    for f in range(0,len(FileList)):
        ...
        for t in range(2,4):
            ...
            del Temp2["point"]
            Single = pd.merge(Single,Temp2,on=["available_date","prediction_date"],suffixes=('',str(t)))
...
##         Load Forecasting
# $$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
def LoadForecasting(WeatherDemand):
...
#####         Parameters
# $$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
SubmissionDate = "2016-04-10"
TargetDate=pd.to_datetime(SubmissionDate).date()

# Answer
Answer=np.array([10.5,9,8,8.19,8.19,9,11.9,19,21.25,25.68,23.69,21,20.69,20,18.5,15.5,15,15.69,16.69,
                 19.01,25.01,31.49,27.86,20])
...
## Load Forecasting
WeatherDemand=pd.merge(TotalWeather,PTAverageGen,how="left",on=["prediction_date","Year","Month","Day","Hour"])
WeatherDemand=pd.merge(WeatherDemand,Energy,how="left",on=["prediction_date","Year","Month","Day","Hour"])
DemandSupport = LoadForecasting(WeatherDemand)
...
#Param['Gamma']=0.001
#Param['Epsilon']=3.1
#Param['MachineList']=["GBM"]
#for k in range(0,10):
#    Param['GBM_NTry']=100 + 100 * k
...
DemandSupport2 = LoadForecasting(WeatherDemand2)
...
#Param['MachineList']=["Ridge","Reg","GBM"]
FunRMSE = CrossVal(AvailableDate,TotalTrainX,TotalTrainY,Param)
#Weight, BestGroup, BestMachine = QuickEnsemble(Param,FunRMSE)
#SaveForecast=FinalTraining(TotalTrainX,TotalTrainY,TotalTestX,Weight,BestGroup,BestMachine,Param)
