...
def OldWeatherRead(OldWeatherLoc, OldWeatherFile):
    ...
    WindSelection = ["temperature","WindSquareA","WindSquareB","WindSquareC","WindSquareD",
                 "wind_speed_100m","wind_speed","wind_gust","radiation"]
    ...
    for t in WeatherRange:
        ...
        Temp2 = Temp2[np.append(ID,WindSelection)]
...
def SingleWeather(WeatherFileLoc):
    ID=["available_date","prediction_date"]
    WindSelection = ["temperature","WindSquareA","WindSquareB",
                     "WindSquareC","WindSquareD",
                     "wind_speed_100m","wind_speed","wind_gust",
                     "radiation"]
...
def CrossVal(AvailableDate,TrainX,TrainY,Param):
    ...
    for cv in range(0,CVN):
        CVTarget1 = TargetDate - datetime.timedelta(days=(CVN+4)) + datetime.timedelta(days=cv)
        ...
        plt.plot(range(0,len(SingleOutput)),SingleOutput,'rs-',range(0,len(SingleOutput)),SingleSolution,'g^-')
        plt.show()
...
def Machinery(MachineInfo,TrainX,TrainY,TestsX,Param):
    ...
    if MachineInfo=="Reg":
        ...
        MAX=max(TrainY)
        TrainY=TrainY*1.0/MAX
        Attribute.fit(TrainX,TrainY)
        TestOutput=Attribute.predict(TestsX) * 1.0 * MAX
        return TestOutput
...
##         Load Forecasting
# $$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
def LoadForecasting(WeatherDemand,Threshold):
    ...
    DemandSupport = DemandSupport.sort(["available_date","prediction_date"],ascending=[1,1])
...
# $$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
def TrainAndTestGen(WeatherPrice):
    # TestX
...
# Answer
Answer=np.array([20.69,19.75,15,13.9,13.8,15.69,20,20.69,
                 21.69,24.4,26,22.09,21.2,20.8,20.4,19,17.15,19.53,19.9,20.4,23.69,32.24,25,20.25])
...
##      Old and New Weather Data Merging
...
## Forecasting Data Gen
MergeIndex = ["prediction_date","Year","Month","Day","Hour"]
SubWeather=pd.merge(TotalWeather,Energy,how="left",on=MergeIndex)

## ES Load Forecasting
SubWeather = pd.merge(SubWeather,PTAverageGen,how="left",on=MergeIndex)
#DemandSupport = LoadForecasting(SubWeather,DemandThreshold)
...
## ES Wind Forecasting
SubWeather=pd.merge(TotalWeather,ESWind,how="left",on=MergeIndex)
SubWeather.rename(columns={'Wind': 'Demand'}, inplace=True)
#ESWindSupport = LoadForecasting(SubWeather,ESWindThreshold)
...
## PT Wind Forecasting
SubWeather=pd.merge(TotalWeather,PTWind,how="left",on=MergeIndex)
SubWeather.rename(columns={'Wind': 'Demand'}, inplace=True)
#PTWindSupport = LoadForecasting(SubWeather,PTWindThreshold)
...
#del WeatherPrice["Day"]    ## Always Delete
#del WeatherPrice["Month"]    ## Always Delete
#del WeatherPrice["Year"]    ## Always Delete

# $$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
##############          Training and Testing Data Generation
# $$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
TotalTrainX, TotalTrainY, TotalTestX, AvailableDate, Tracker =  TrainAndTestGen(WeatherPrice)
...
WeatherDemand2=pd.merge(WeatherPrice2,PTAverageGen,how="left",on=["prediction_date","Year","Month","Day","Hour"])
...
WeatherPrice2 = WeatherPrice2.sort(["available_date","prediction_date"],ascending=[1,1])
del WeatherPrice2["WeekDay"]
TotalTrainX, TotalTrainY, TotalTestX, AvailableDate, Tracker =  TrainAndTestGen(WeatherPrice2)
...
t=range(0,24)
plt.plot(t,FinalValue[:24],'g^-',t,Answer,'rs-')
plt.show()
